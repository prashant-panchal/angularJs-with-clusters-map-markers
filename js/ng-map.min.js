        ...
        function() {
            b.module("uiGmapgoogle-maps.directives.api.utils").service("uiGmapIsReady", ["$q", "$timeout", function(a, b) {
                ...
                return c = 0, e = [], d = function() {
                    ...
                    decrement: function() {
                        return c -= 1, e.length = e.length - 1
                    }
                }
            }])
        }.call(this),
                ...
                return function(c, d, e, f) {
                    ...
                    return j = !1, n = d.$eval(e), d["static"] || (k = {
                            ...
                            set_at: function(a) {
                                var b;
                                if (!j && (b = c.getAt(a),
                                        b && b.lng && b.lat)) return g[a][1] = b.lat(), g[a][0] = b.lng()
                            },
                            insert_at: function(a) {
                                var b;
                    ...
                    return c(l, b), l.include(d), l.include(f), l.include(h), m = function(a) {
                        ...
                        if (null == b && (b = !0), !this.isNotValid(a, !1)) {
                            if (this.renderGMarker(b, function(b) {
                                    return function() {
                                        var c, d, e;
                                        return d = b.getProp("coords", a, b.model), e = b.getProp("icon", a, b.model), c = b.getProp("options", a, b.model), b.opts = b.createOptions(d, e, c), b.isLabel(b.gObject) !== b.isLabel(b.opts) && null != b.gObject && (b.gManager.remove(b.gObject), b.gObject = void 0), null != b.gObject && b.gObject.setOptions(b.setLabelOptions(b.opts)), b.gObject || (b.gObject = b.isLabel(b.opts) ? new MarkerWithLabel(b.setLabelOptions(b.opts)) : new google.maps.Marker(b.opts), _.extend(b.gObject, {
                                            model: b.model
            ...
            b.module("uiGmapgoogle-maps.directives.api.models.parent").factory("uiGmapCircleParentModel", ["uiGmapLogger", "$timeout", "uiGmapGmapUtil", "uiGmapEventsHelper", "uiGmapCircleOptionsBuilder", function(c, d, e, f, g) {
                ...
                return h = function(d) {
                    function g(a, d, f, g, h) {
                        var i, j, k;
                        this.attrs = f, this.map = g, this.DEFAULTS = h,
                            this.scope = a, k = null, i = function(a) {
                                return function() {
